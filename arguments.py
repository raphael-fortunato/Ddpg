...
def GetArgs():
        ...
        parser.add_argument('--gamma', type=float, default= .95, help='the discount ratio')
        parser.add_argument('--num-rollouts-per-mpi', type=int, default=2, help='the rollouts per mpi')
        parser.add_argument('--cuda', action='store_true', help='use the gpu to train the networks')
